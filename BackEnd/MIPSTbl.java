...
public class MIPSTbl {
    ...
    public static final int[] t_reg_nums = new int[] {3, 5, 6, 7};
    public static final int[] s_reg_nums = new int[] {16, 17, 18, 19, 20, 21, 22, 23, 30, 8, 9, 10, 11, 12, 13, 14, 15, 24, 25, 26};
